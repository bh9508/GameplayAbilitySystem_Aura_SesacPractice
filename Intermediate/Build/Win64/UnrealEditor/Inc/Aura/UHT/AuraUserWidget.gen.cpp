...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAuraUserWidget_WidgetControllerSet_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "// As soon as Widgetcontroller is set, we need BeginPlay-like function \n" },
#endif
		{ "ModuleRelativePath", "Public/UI/Widgets/AuraUserWidget.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "As soon as Widgetcontroller is set, we need BeginPlay-like function" },
#endif
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAuraUserWidget_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAuraUserWidget_WidgetControllerSet, "WidgetControllerSet" }, // 2885628330
	};
	...
	struct Z_CompiledInDeferFile_FID_byunghoon_Unreal_Aura_Source_Aura_Public_UI_Widgets_AuraUserWidget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_byunghoon_Unreal_Aura_Source_Aura_Public_UI_Widgets_AuraUserWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAuraUserWidget, UAuraUserWidget::StaticClass, TEXT("UAuraUserWidget"), &Z_Registration_Info_UClass_UAuraUserWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAuraUserWidget), 1042099372U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_byunghoon_Unreal_Aura_Source_Aura_Public_UI_Widgets_AuraUserWidget_h_3807463374(TEXT("/Script/Aura"),
		Z_CompiledInDeferFile_FID_byunghoon_Unreal_Aura_Source_Aura_Public_UI_Widgets_AuraUserWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_byunghoon_Unreal_Aura_Source_Aura_Public_UI_Widgets_AuraUserWidget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
